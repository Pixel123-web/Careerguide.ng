...
const Modal = () => {
  ...
  <table className = "elementsContainer ">
      <tr>
      <td>
        <a className="btn btn-primary py-2 mx-0 ps-2" href="#" role="button"><AiOutlineMail></AiOutlineMail></a>
        </td>
        <td>
  ...
  <div className="form-check">
    ...
    <label className="fw-bold form-check-label" for="exampleCheck1">I agree to recieve regular updates about Webinars, Blog Posts and Services.</label>
  </div >
  <div className = "text-center">
  <button type="submit" className="btn btn-custom my-2 w-100">SUBSCRIBE</button>
  </div>
